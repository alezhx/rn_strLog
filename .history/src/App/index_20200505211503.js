...
import WorkoutsTab from "src/views/WorkoutsStack/WorkoutsTab";
...
const WorkoutStackScreen = () => (
  ...
  >
    <WorkoutStack.Screen name="Workout tab" component={WorkoutsTab}/>
    <WorkoutStack.Screen 
      name="Workouts n Exercises"
...
const TabsScreen = () => (
  <Tabs.Navigator>
    ...
    <Tabs.Screen name="Workouts" component={WorkoutsTab} />
