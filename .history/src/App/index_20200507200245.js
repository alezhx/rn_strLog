...
import {
  Settings
} from 'src/views/Settings/Settings'
...
const HomeStackScreen = () => (
  ...
  >
    ...
    <HomeStack.Screen
      name="Workouts"
      component={WorkoutsAndExercises}
    />
    <HomeStack.Screen
      name="New Workout"
...
const TabsScreen = () => (
    ...
    screenOptions={({ route }) => ({
      tabBarIcon: ({ focused, color, size }) => {
        ...
        if (route.name === 'strLog') {
          ...
          return <FontAwesome name={'dumbbell'} size={0.9*size} color={color}/>
  ...
  >
    ...
    <Tabs.Screen name="Workouts" component={WorkoutsAndExercises} />
