...
export default class NewWorkout extends Component {
  ...
  renderSectionListItem = (item, index) => {
    if (item.type) {
      ...
      return (
        <TouchableOpacity style={{backgroundColor:'rgba(10,132,255,0.3)', padding:12}}>
  ...
  renderSaveButton = () => {
    return (
      <View style={{width:'100%', height: '10%', backgroundColor:palette.green}}>
        <Button
          buttonStyle={{height:'100%'}}
          iconContainerStyle={{width:50, height:50, paddingRight:30,backgroundColor:'red'}}
          icon={
            <Icon
