        ...
        <SectionList
          ...
          <View>
            ...
            <HighlightButton
              ...
              style={{padding:15}}
              underlayBackgroundColor={palette.black}
              onShowUnderlay={()=>this.setState({addExerciseButtonHighlighted:true})}
              onHideUnderlay={()=>this.setState({addExerciseButtonHighlighted:false})}
            >
              <View style={{position:'absolute', right:15, top:'50%'}}>
                <Icon 
                  name={this.state.addExerciseButtonHighlighted ? 
                    "ios-add-circle" : "ios-add-circle-outline"}
                  size={30}
                  color={this.state.addExerciseButtonHighlighted ? 
                    palette.white : palette.newBlue
                  }
                />
              </View>
            </HighlightButton>
